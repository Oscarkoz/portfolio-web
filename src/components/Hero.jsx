...
const Hero = () => {
  ...
  return (
    <section
      id="hero"
      className="min-h-screen flex flex-col justify-center items-center text-center px-4 bg-gradient-to-b from-blue-50 to-blue-100 dark:from-gray-900 dark:to-gray-800"
    >
      {/* Live vädervisning */}
      {weather && (
